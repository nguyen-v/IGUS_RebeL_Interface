...
void ccTalk::print_coin_value(uint8_t value) {
  switch(value) {
    case CHF_500:
      Serial.println(F("Coin Value: 5 CHF"));
      break;
    case CHF_200:
      Serial.println(F("Coin Value: 2 CHF"));
      break;
    case CHF_100:
      Serial.println(F("Coin Value: 1 CHF"));
      break;
    case CHF_050:
      Serial.println(F("Coin Value: 50 cents"));
      break;
    case CHF_020:
      Serial.println(F("Coin Value: 20 cents"));
      break;
    case CHF_010:
      Serial.println(F("Coin Value: 10 cents"));
      break;
    case INVALID_COIN:
      Serial.println(F("Invalid coin"));
      break;
    case NO_COINS:
      Serial.println(F("No coins"));
      break;
    default:
      Serial.println(F("No coins"));
      break;      
